...
const PATHS: Record<IconName, string> = {
  ...
  sparkles:
    '<path d="m12 3 1.9 5.7 5.8 1.9-5.8 1.9L12 18.4l-1.9-5.9-5.8-1.9 5.8-1.9L12 3z"/><path d="M19 14.5l.8 2.4 2.4.8-2.4.8-.8 2.4-.8-2.4-2.4-.8 2.4-.8.8-2.4z"/><path d="M5 3l.7 2.1 2.1.7-2.1.7L5 8.6l-.7-2.1L2.2 5.8l2.1-.7L5 3z"/>',
...
export function icon(name: IconName, cls = 'h-5 w-5'): string {
...
export type BrandIconName = 'google' | 'github';

/** Full-color brand marks (fill-based), kept separate from the stroke-based icon set above. */
export function brandIcon(name: BrandIconName, cls = 'h-4 w-4'): string {
  if (name === 'google') {
    return `<svg class="${cls}" viewBox="0 0 18 18" aria-hidden="true">
